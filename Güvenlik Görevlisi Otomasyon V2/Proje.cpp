...
void GorevliListele() {
    ...
    if (kayitsayisi > 0) {
        oku.seekg(0, ios::beg);
        char arananGun[10];
        cout << "Listelemek istediðiniz günü giriniz (Hepsi için 'hepsi'): ";
        cin >> arananGun;
        for (int i = 0; i < kayitsayisi; i++) {
            oku.read((char*)&gorevli, sizeof(gorevli));
            if (strcmp(arananGun, "hepsi") == 0 || strcmp(arananGun, gorevli.gun) == 0) {
